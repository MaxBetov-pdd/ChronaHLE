...
ChronaHLE includes software from touchHLE.
touchHLE copyright 2023-2026 touchHLE project contributors.
ChronaHLE modifications copyright 2026 ChronaHLE contributors.
";

const MAIN_LICENSE: &str = "
ChronaHLE and the touchHLE source files it is derived from are provided under
the Mozilla Public License, version 2.0. A copy is included in the repository
and source distributions as LICENSE.

This software is provided without warranty. See LICENSE for the complete
license terms. Third-party components and bundled runtime files retain their
respective licenses.
";

// See android/app/src/main/java/org/chronahle/android/DocumentsProvider.kt
#[cfg(target_os = "android")]
const SKYLINE: &str = "
ChronaHLE for Android incorporates code originally from the Skyline emulator
...
ChronaHLE, and therefore this executable, incorporates the following Rust
...
ChronaHLE, and therefore this executable, incorporates the library Dynarmic:
";
...
Dynarmic, and therefore ChronaHLE, and therefore this executable, incorporates
...
ChronaHLE, and therefore this executable, incorporates the library SDL 2, which
...
ChronaHLE, and therefore this executable, incorporates the library OpenAL Soft,
which is available under the terms of the GNU Library Public License version 2
or any later version.
";

const STB_IMAGE: &str = "
ChronaHLE, and therefore this executable, incorporates the library stb_image,
which is available either as Public Domain or under the terms of the MIT
license.
";

const PVRTD_DESCRIPTION: &str = "
ChronaHLE, and therefore this executable, incorporates PVRTC decompression code
...
This distribution of ChronaHLE includes binaries for the libgcc and libstdc++
libraries from the Free Software Foundation, as originally distributed by Apple:
";

const INTERNAL_ZLIB_DYLIB_DESCRIPTION: &str = "
This distribution of ChronaHLE includes binaries for zlib (libz), available under
...
This distribution of ChronaHLE includes binaries for SQLite (libsqlite3),
available under Public Domain.
";

const INTERNAL_XML2_DYLIB_DESCRIPTION: &str = "
This distribution of ChronaHLE includes binaries for libxml2, available under
the following license:
";

const INTERNAL_LIBERATION_FONTS_DESCRIPTION: &str = "
This distribution of ChronaHLE includes Liberation Sans fonts, available under
the following license:
";

const INTERNAL_NOTO_FONTS_DESCRIPTION: &str = "
This distribution of ChronaHLE includes Noto Sans CJK fonts, available under the
following license:
";
