...
pub struct AudioComponentInstanceHostObject {
    ...
    pub al_source_primed: bool,
    pub target_queued_buffers: i32,
    pub is_running_handler: bool,
    pub render_config_logged: bool,
}
impl Default for AudioComponentInstanceHostObject {
    fn default() -> Self {
        ...
        AudioComponentInstanceHostObject {
            ...
            al_source: None,
            al_source_primed: false,
            target_queued_buffers: 5,
            is_running_handler: false,
            render_config_logged: false,
        }
    }
}
