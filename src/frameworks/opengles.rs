...
use chronahle_gl_bindings::gles11::types::GLenum;
...
pub struct State {
    ...
    scaled_renderbuffers: std::collections::HashMap<u32, bool>,
    scaled_textures: std::collections::HashMap<u32, bool>,
    scaled_framebuffers: std::collections::HashMap<u32, bool>,
}
impl State {
