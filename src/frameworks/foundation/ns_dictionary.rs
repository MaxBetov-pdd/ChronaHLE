...
- (())enumerateKeysAndObjectsWithOptions:(NSUInteger)_options
                              usingBlock:(ConstVoidPtr)block {
    msg![env; this enumerateKeysAndObjectsUsingBlock:block]
}
